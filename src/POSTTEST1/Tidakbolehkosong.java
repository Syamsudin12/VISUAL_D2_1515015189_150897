 ...
 * @author Acer-pc
 */
public class Tidakbolehkosong extends javax.swing.JFrame {
    private Object txtNPM;

    /**
     * Creates new form NewJFrame
     */
    public Tidakbolehkosong() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tidakbolehkosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tidakbolehkosong().setVisible(true);
            }
        });
    }
